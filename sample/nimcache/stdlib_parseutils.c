...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/mnt/d/Nim/lib -o /mnt/d/pyvmomi/sample/nimcache/stdlib_parseutils.c.o /mnt/d/pyvmomi/sample/nimcache/stdlib_parseutils.c */
